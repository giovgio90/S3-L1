...
console.log(totalSum([1, 4, 8, 5, 12, 5, 14, 17, 19, 20]));
...
const casualNumbers = [23, 35, 43, 78, 90];
const n = 10;

const incrementaArray = casualNumbers.map((numeri) => numeri + n);
...
console.log(lunghezze(["Ciao", "sono", "Giovanni"]));
